Feature :  Editar ou Remover a Disciplina / Assunto do usuário Professor
...
Scenario: Remoção de um evento pelo usuário Professor

    Given   “Cadastrar Evento”, “Ver Disciplinas”, e “Ver eventos”
    And Eu estou logado como “Professor”
...
Scenario: Edição de funcionalidades de uma Disciplina pelo Professor 
    ...
    And Eu vejo as disciplinas “Engenharia de Software e Sistemas”, “Gerenciamento de Dados e Informações” e “Sistemas Digitais”
    And Eu vejo as opções “Remover” e “Editar”
    When Eu clico na opção “Editar” da Disciplina “Engenharia de Software e Sistemas”
...
Scenario: Remoção de uma disciplina com sucesso pelo Professor sem sucesso
    ...
    And Eu vejo as disciplinas “Engenharia de Software e Sistemas”, “Gerenciamento de Dados e Informações” e “Sistemas Digitais”
    Cenário 6: Remoção de um evento pelo usuário Professor sem sucesso
    Given Eu estou na página de “Disciplinas”
    And  Eu vejo a aba “Cadastrar Disciplina”, “Cadastrar Evento”, “Ver Disciplinas”, e “Ver eventos”
    And Eu estou logado como “Professor”
    When  Eu abro a aba “Ver Eventos”
